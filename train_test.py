...
def test_net(testloader, classes, net, criterion, epoch, true_positives, true_negatives, false_positives, false_negatives, validation_loss, test_accuracy, f1_score, test_images, test_image_label, test_image_pred):
    with torch.no_grad():
        val_loss = 0.0
        val_i = 0
        out = 0.0
...
def loop_epoches(trainloader, testloader, classes, net, criterion, optimizer):
    epoches = []
    train_loss = []
    ...
    for epoch in range(5):
        ...
        net.eval()
        test_net(testloader, classes, net, criterion, epoch, true_positives, true_negatives, false_positives, false_negatives, validation_loss, test_accuracy, f1_score, test_images, test_image_label, test_image_pred)
...
def train_test(trainloader, testloader, classes, net, criterion, optimizer, date_time):
    net_trained, epoches, train_loss, train_images, train_image_label, test_accuracy, f1_score, validation_loss, test_images, test_image_label, test_image_pred = loop_epoches(trainloader, testloader, classes, net, criterion, optimizer)
